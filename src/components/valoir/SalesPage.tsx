      ...
      <main className="container mx-auto px-4">
        ...
        <section className="relative text-center py-20 md:py-32 min-h-[80vh] flex flex-col items-center justify-center">
          ...
          <h2 className="font-headline text-5xl md:text-7xl text-white tracking-wider">
            De <span className="line-through text-white/50">R$299</span> por apenas <span className="text-primary text-shadow-gold">R$67</span>
          </h2>
          <p className="font-body text-xl md:text-2xl mt-4 text-white/80 max-w-2xl">Surpreenda. Impulsione seu status. Sinta-se invencível.</p>
          <div className="my-8 bg-black/50 border border-primary/20 rounded-lg p-4 flex flex-col items-center gap-2">
            <CountdownTimer initialMinutes={15} className="font-mono text-4xl text-primary font-bold" />
            <p className="text-sm text-primary/80">A OFERTA ACABA EM</p>
          </div>
          <Button onClick={handleRedirectToCheckout} size="lg" className="font-headline text-2xl tracking-widest px-12 py-8 animate-pulse-glow shadow-gold">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <ul className="mt-4 space-y-2 text-lg text-white/80">
                ...
                <li className="flex items-center gap-3"><CheckCircle className="text-primary"/>Vidro de Safira Antirrisco</li>
              </ul>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center mt-12">
             <div className="text-right md:order-2">
              ...
              <ul className="mt-4 space-y-2 text-lg text-white/80">
                ...
                <li className="flex items-center justify-end gap-3"><CheckCircle className="text-primary"/>Fecho de Gaveta Seguro</li>
              </ul>
            </div>
        ...
        <section className="py-20 text-center">
            <h2 className="font-headline text-5xl text-white">Sua Oportunidade Única</h2>
            <Card className="mt-8 max-w-2xl mx-auto bg-card border-2 border-dashed border-primary/50 p-8">
                {!isDiscountClaimed ? (
                    <>
                    ...
                    <div className="animate-fade-in-up">
                       <h3 className="font-headline text-3xl text-primary">PARABÉNS!</h3>
                       <p className="text-xl mt-2">Você ganhou <span className="font-bold text-primary">77% DE DESCONTO</span> e acesso ao preço final de <span className="font-bold text-primary">R$67</span>.</p>
                       <Button onClick={handleRedirectToCheckout} size="lg" className="mt-8 font-headline text-2xl tracking-widest px-12 py-8 animate-pulse-glow shadow-gold">
        ...
        {/* Social Proof */}
        <section className="py-20">
          <h2 className="text-center font-headline text-5xl text-white mb-12">Quem Comprou, Aprovou</h2>
        ...
        {/* Guarantee Section */}
        <section className="py-20">
            <Card className="bg-card border-primary/20 max-w-4xl mx-auto p-8 md:p-12">
        ...
        <section className="text-center py-20">
            ...
            <Card className="max-w-xl mx-auto mt-8 p-8 bg-card border-primary/20 shadow-lg shadow-primary/20">
                 ...
                 <Button onClick={handleRedirectToCheckout} size="lg" className="w-full font-headline text-2xl tracking-widest px-12 py-8 animate-pulse-glow shadow-gold">
                   Finalizar Pedido com Desconto
                 </Button>
            </Card>
        </section>
